...
static UA_StatusCode twoStateThunkEnabled(UA_Server* s, const UA_NodeId* condition) {
...
static UA_StatusCode twoStateThunkAcked(UA_Server* s, const UA_NodeId* condition) {
    auto* srv = opcua::asWrapper(s);
    auto& condId = *opcua::asWrapper<opcua::NodeId>(condition);
...
static UA_StatusCode twoStateThunkConfirmed(UA_Server* s, const UA_NodeId* condition) {
    auto* srv = opcua::asWrapper(s);
    auto& condId = *opcua::asWrapper<opcua::NodeId>(condition);
...
static UA_StatusCode twoStateThunkActive(UA_Server* s, const UA_NodeId* condition) {
    auto* srv = opcua::asWrapper(s);
    auto& condId = *opcua::asWrapper<opcua::NodeId>(condition);
